            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__about__logo">
                        <h2>Venta <a href="./index.html"><img src="<?php echo BASE_URL ?>/public/images/logo.png" alt=""></a></h2>
                    </div>
                    <ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer__copyright">
                    ...
                    <div class="footer__copyright__payment"><img src="<?php echo BASE_URL ?>/public/images/payment-item.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
