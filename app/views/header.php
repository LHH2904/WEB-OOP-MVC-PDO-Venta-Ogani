...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL ?>/public/images/logo.png" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="<?php echo BASE_URL ?>/public/images/language.png" alt="">
                <div>English</div>
            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="<?php echo BASE_URL ?>/giohang/cart">Shop Details</a></li>
                        <li><a href="<?php echo BASE_URL ?>/giohang/cart">Shoping Cart</a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <h2>Venta <a href="<?php echo BASE_URL ?>"><img
                                    src="<?php echo BASE_URL ?>/public/images/logo.png" alt=""></a></h2>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="<?php echo BASE_URL ?>/sanpham/all">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="<?php echo BASE_URL ?>/giohang">Shoping Cart</a></li>
                                    <li><a href="./checkout.html">Check Out</a></li>
                                    <li><a href="<?php echo BASE_URL ?>/index/lienhe">Contact</a></li>
                                    <li><a href="<?php echo BASE_URL ?>/tintuc/all">Blog</a></li>
                                </ul>
                            </li>
                            <li><a href="<?php echo BASE_URL ?>/user/dangky">Sign up</a></li>
                            <?php
                            if (Session::get('customer') === true) {
                            ?>
                            <li><a href="<?php echo BASE_URL ?>/user/dangnhap">Logout</a></li>
                            <?php
                            } else {
                            ?>
                            <li><a href="<?php echo BASE_URL ?>/user/dangxuat">Login</a></li>
                            <?php
                            }
                            ?>
                        </ul>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="<?php echo BASE_URL ?>/giohang"><i class="fa fa-shopping-bag"></i>
                                    <span>3</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>$150.00</span></div>
                    </div>
